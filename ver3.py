...
def normalize_technician_name(name):
    ...
    # Remover espaços extras, converter para minúsculas e normalizar
    normalized = name.strip().lower()
    
    # Remover acentos e caracteres especiais (opcional)
    # normalized = unidecode(normalized)  # Requer: from unidecode import unidecode
...
def process_technician_names(technician_str):
    ...
    techs = [normalize_technician_name(tech) for tech in normalized.split(',')]
